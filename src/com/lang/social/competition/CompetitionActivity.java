...
public class CompetitionActivity extends Activity
	...
	private void setButtonChatListener() {
		sendChatMsgButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				JSONUtils.setStringValue(json, "GameType",  GameType.HeadToHeadQuizGame.toString());
		    ...
		    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
		        public void onClick(DialogInterface dialog, int which) { 
		        	if(mUserState.equals(SocialGameConstants.IntentRoomStateVALUECreated)){
		        		...
		        		new UserSessionManager(CompetitionActivity.this).logOutUser();
		        	} else {
	...
	private void moveUserHostBackToWaitingRoom() {
    	...
    	intent.putExtra(RoomConstants.GameTypeKEY, GameType.HeadToHeadQuizGame);
