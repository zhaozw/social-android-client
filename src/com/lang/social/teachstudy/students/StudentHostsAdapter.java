...
public class StudentHostsAdapter extends ArrayAdapter<StudentTeacherGameItem> {
	private Context context;
	private int layoutResourceId;
	private ArrayList<StudentTeacherGameItem> studentTeacherGameItems;
	
	public StudentHostsAdapter(Context context, int layoutResourceId, ArrayList<StudentTeacherGameItem> studentTeacherGameItems){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tvStudyingLabel = (TextView) itemView.findViewById(R.id.tvTeacherStudentLabel);
		tvStudyingLabel.setText("Student:");
